...
| ---------------- | ---------------- | ----- | ---- |
| James Madden     | Tech Lead        |     | <ul><li> Implemented order related use cases</li><li> Implemented authentication</li></ul>|
...
| Julien Heng      | Developer        |     | <ul><li> Implemented game related use cases</li><li> Implemented discounts on orders</li><li> API endpoint description</li></ul> |
