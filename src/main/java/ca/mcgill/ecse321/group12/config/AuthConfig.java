...
public class AuthConfig {
  ...
  SecurityFilterChain secuirtyFilterChain(HttpSecurity httpSecurity) throws Exception {
    ...
    // see https://github.com/McGill-ECSE321-Fall2024/project-group-12/wiki/API-Endpoints for the list of endpoints
    return httpSecurity
      ...
      .authorizeHttpRequests(authorize -> authorize
        ...
        // comments: anyone can get them (to see), only users can post, put, or delete
        ...
        // customer: anyone can create (signing up!), only employees can get all, and only users can get/modify specific
        .requestMatchers(HttpMethod.POST, "/customers").permitAll()
        .requestMatchers(HttpMethod.GET, "/customers").hasRole("EMPLOYEE")
        ...
        // employees: only managers or employees should be permitted to use these endpoints,
        // but for testing, allow anyone
        // no need to do anything since they'll fall under the catchall at the bottom
        // games: anyone can get games, but only employees can post and put games
        .requestMatchers(HttpMethod.GET, "/games").permitAll()
        .requestMatchers(HttpMethod.GET, "/games/*").permitAll()
        .requestMatchers(HttpMethod.POST, "/games").hasRole("EMPLOYEE")
        .requestMatchers(HttpMethod.PUT, "/games/*").hasRole("EMPLOYEE")
        ...
        .requestMatchers(HttpMethod.PUT, "/orders/*").hasRole("CUSTOMER")
