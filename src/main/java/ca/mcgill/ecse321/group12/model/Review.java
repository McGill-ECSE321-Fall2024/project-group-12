...
public class Review {
	...
	public Review(int aId, int aLikeCount, int aRating, String aText, Game aGame, Customer aCustomer) {
		...
		if (!setGame(aGame)) {
			throw new RuntimeException(
					"Unable to create Review due to aGame. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
		}
	...
	public String toString() {
		return super.toString() + "[" + "id" + ":" + getId() + "," + "likeCount" + ":" + getLikeCount() + "," + "rating"
				+ ":" + getRating() + "," + "text" + ":" + getText() + "]"
