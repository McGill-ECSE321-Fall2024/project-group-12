...
public class Order {
	...
	public Order(int aId, Date aPurchaseDate, float aPurchaseTotal, String aDeliveryAddress, Customer aCustomer,
		...
		if (!didAddGames) {
			throw new RuntimeException(
					"Unable to create Order, must have at least 1 games. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
		}
		...
		if (!setCardPayment(aCardPayment)) {
			throw new RuntimeException(
					"Unable to create Order due to aCardPayment. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
		}
	}
	...
	public String toString() {
		return super.toString() + "[" + "id" + ":" + getId() + "," + "purchaseTotal" + ":" + getPurchaseTotal() + ","
				+ "deliveryAddress" + ":" + getDeliveryAddress() + "]"
				+ System.getProperties().getProperty("line.separator") + "  " + "purchaseDate" + "="
				+ (getPurchaseDate() != null ? !getPurchaseDate().equals(this)
						? getPurchaseDate().toString().replaceAll("  ", "    ") : "this" : "null")
				...
				+ System.getProperties().getProperty("line.separator") + "  " + "cardPayment = "
				+ (getCardPayment() != null ? Integer.toHexString(System.identityHashCode(getCardPayment())) : "null");
	}
