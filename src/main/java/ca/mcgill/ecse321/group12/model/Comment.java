...
public class Comment {
	...
	public Comment(int aId, String aText, Review aReview) {
		...
		if (!didAddReview) {
			throw new RuntimeException(
					"Unable to create comment due to review. See https://manual.umple.org?RE002ViolationofAssociationMultiplicity.html");
		}
	}
	...
	public String toString() {
		return super.toString() + "[" + "id" + ":" + getId() + "," + "text" + ":" + getText() + "]"
				+ System.getProperties().getProperty("line.separator") + "  " + "review = "
				+ (getReview() != null ? Integer.toHexString(System.identityHashCode(getReview())) : "null");
	}
