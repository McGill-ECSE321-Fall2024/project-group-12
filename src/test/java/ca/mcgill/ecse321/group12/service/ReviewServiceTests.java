...
public class ReviewServiceTests {
    ...
    public void testCreateReview() {
        ...
        // call the service
        Review returnedReview = reviewService.createReview(likeCount, rating, reviewText, createdGame.getId(), createdCustomer.getId());
        ...
        public void updateReviewWithValidArguments(){
           ...
           // when(gameRepository.findGameById(gameId)).thenReturn(createdGame);
            ...
            reviewService.updateReview(reviewId, updatedLikeCount, updatedRating, updatedReviewText, createdGame.getId(), createdCustomer.getId());
