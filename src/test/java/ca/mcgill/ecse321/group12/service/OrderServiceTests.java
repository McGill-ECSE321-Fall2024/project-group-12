...
public class OrderServiceTests {
	...
	/**
	 * Test that an order can be successfully created. Error for games being out of stock
	 * is tested seperately in integration and GameService tests.
	 * @author James Madden
	 */
	@Test
	...
	public void testUnsuccessfullyReturnOrder() {
		...
		CustomException error = assertThrows(CustomException.class,
				() -> service.updateStatus(id, OrderStatus.Shipping));
