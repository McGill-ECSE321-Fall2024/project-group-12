...
public class AuthServiceTests {
	...
	/**
	 * Test that an auth token is successfully created, and that the account details can
	...
	/**
	 * make sure that the matchUserAndToken will throw if a different user and auth code
	 * are provided
	 * @author James Madden
	 */
	public void testUnsuccessfullyMatchUserAndToken() {
		...
		CustomException error = assertThrows(CustomException.class,
				() -> authService.matchUserAndToken(customer2, auth));
